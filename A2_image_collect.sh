...
# ★ group_vars/all.yml 과 동기화 필요 (쉘 스크립트는 Ansible 변수를 읽지 못함)
HARBOR_HOST="${HARBOR_HOST:-harbor.miso.local}"        # base_domain 에 맞게 수정
HARBOR_PROJECT="${HARBOR_PROJECT:-miso}"               # harbor_project
HARBOR_USER="${HARBOR_USER:-admin}"
HARBOR_PASSWORD="${HARBOR_PASSWORD:-Harbor12345}"      # harbor_admin_password
